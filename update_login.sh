        ...
        <div className="bg-slate-50 flex flex-col items-center justify-center min-h-screen p-4">
            <div className="bg-white p-8 rounded-[24px] shadow-xl w-full max-w-md border border-slate-100 relative overflow-hidden">
                ...
                <div className="text-center mb-8 mt-2">
                    ...
                    <p className="text-sm text-slate-500 font-medium">
                        {isLoginMode ? "Welcome back! Please enter your details." : "Sign up to access the portal."}
                    </p>
                </div>
                ...
                <form onSubmit={handleAuth} className="space-y-5">
                    ...
                    {successMsg && <p className="text-emerald-600 text-sm font-bold text-center bg-emerald-50 py-2.5 px-3 rounded-xl border border-emerald-100">{successMsg}</p>}
                    {errorMsg && <p className="text-rose-500 text-sm font-bold text-center bg-rose-50 py-2.5 px-3 rounded-xl border border-rose-100">{errorMsg}</p>}
                    ...
                    >
                        {isProcessing ? "Processing..." : (isLoginMode ? "Sign In" : "Create Account")}
                    </button>
                </form>
                ...
                <div className="relative flex items-center justify-center w-full mt-7 mb-7">
                    ...
                    <span className="bg-white px-4 text-[11px] text-slate-400 font-bold uppercase tracking-wider relative z-10">OR</span>
                </div>
            ...
            <div className="mt-8 text-center">
                <p className="text-slate-500 text-sm font-medium mb-1">
                    Developed By <span className="font-bold text-slate-700">Satyam Tech Solutions</span>
                </p>
                <div className="flex items-center justify-center gap-4 text-xs font-medium text-slate-500 mb-2">
                    <a href="tel:+919263258348" className="hover:text-blue-600 transition-colors flex items-center gap-1">
                        <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                        +91 92632 58348
                    </a>
                    <span className="text-slate-300">|</span>
                    <a href="tel:180012341234" className="hover:text-blue-600 transition-colors flex items-center gap-1">
                        <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                        1800 1234 1234
                    </a>
                </div>
